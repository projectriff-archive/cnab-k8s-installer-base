...
var manifestsResource = schema.GroupVersionResource{Group: "projectriff.io", Version: "v1alpha1", Resource: "manifests"}

var manifestsKind = schema.GroupVersionKind{Group: "projectriff.io", Version: "v1alpha1", Kind: "Manifest"}
...
func (c *FakeManifests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(manifestsResource, listOptions)
